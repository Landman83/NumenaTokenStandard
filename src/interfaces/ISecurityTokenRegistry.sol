...
interface ISecurityTokenRegistry {
     ...
     * @param _tokenDetails is the off-chain details of the token
     * @param _divisible is whether or not the token is divisible
     * @param _treasuryWallet Ethereum address which will hold the STs
     * @return securityToken Address of the security token
     */
    ...
    */
     ...
     * @return stFactoryAddress address
     */
    ...
    */
     ...
     * @return usdFee uint256
     * @return polyFee uint256
     */
    function getFees(bytes32 _feeType) external view returns (uint256 usdFee, uint256 polyFee);
     ...
     * @return isInPoly bool - true = poly, false = usd
     */
