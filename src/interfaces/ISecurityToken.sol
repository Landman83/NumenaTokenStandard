...
interface ISecurityToken {
     ...
     * @return statusCode Ethereum status code (ESC)
     * @return reasonCode Application specific reason code
     */
     ...
     * @return reasonCode Application specific reason codes with additional details
     * @return partition The partition to which the transferred tokens were allocated for the _to address
     */
     ...
     * @return documentUri The URI associated with the document.
     * @return documentHash The hash (of the contents) of the document.
     * @return documentTime The timestamp at which the document was last modified.
     */
     ...
     * @return documentNames List of all documents names present in the contract.
     */
     ...
     * @return controlled `true` when controller address is non-zero otherwise return `false`.
     */
     ...
     * @return hasPermission Whether the delegate has the permission
     */
     ...
     * @return factoryAddress Module factory address
     * @return isArchived Module archived status
     * @return moduleTypes Array of module types
     * @return moduleLabel Module label
     */
     ...
     * @return modules List of modules with this name
     */
     ...
     * @return modules List of modules with this type
     */
     ...
     * @return checkpointTimes List of checkpoint times
     */
     ...
     * @return checkpointId The current checkpoint ID
     */
     ...
     * @return isValid Whether the `_operator` is an operator for all partitions of `_tokenHolder`
     */
     ...
     * @param _operator The operator to check
     * @param _tokenHolder The token holder to check
     * @return isValid Whether the `_operator` is an operator for a specified partition of `_tokenHolder`
     */
     ...
     * @return dataStoreAddress The data store address
     */
    ...
    */
     ...
     * @param _signature Signature from issuer to freeze the issuance
     */
    ...
    */
     ...
     * @return version array of uint8 contains the version of the securityToken
     */
     ...
     * @param _tokenHolder Whom balance need to queried
     * @return balance Amount of tokens as per the given partitions
     */
    function balanceOfByPartition(bytes32 _partition, address _tokenHolder) external view returns(uint256 balance);

    /**
      * @notice Provides the granularity of the token
      * @return granularityAmount The granularity of the token
      */
    function granularity() external view returns(uint256 granularityAmount);

    /**
      * @notice Provides the address of the polymathRegistry
      * @return registryAddress The address of the polymathRegistry
      */
    ...
    */
     ...
     * @return issuable `true` signifies the minting is allowed. While `false` denotes the end of minting
     */
