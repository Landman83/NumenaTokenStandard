...
library VersionUtils {
    ...
    function lessThanOrEqual(uint8[] memory _current, uint8[] memory _new) internal pure returns(bool) {
        require(_current.length == 3, "Invalid current version length");
        require(_new.length == 3, "Invalid new version length");
        uint8 i = 0;
     ...
     * @return Packed version as uint24
     */
     ...
     * @return _unpackVersion Unpacked version as uint8 array
     */
    function unpack(uint24 _packedVersion) internal pure returns(uint8[] memory _unpackVersion) {
        _unpackVersion = new uint8[](3);
     ...
     * @param _a First uint64 value
     * @param _b Second uint64 value
     * @param _c Third uint64 value
     * @param _d uint8 value
     * @return Packed data as uint256
     */
     ...
     * @param _packedVersion Packed data
     * @return canSendAfter First uint64 value
     * @return canReceiveAfter Second uint64 value
     * @return expiryTime Third uint64 value
     * @return added uint8 value
     */
