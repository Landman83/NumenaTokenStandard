...
library Util {
    ...
    */
     ...
     * @return bytes32 representation of the string
     */
     ...
     * @return bytes32 representation of the bytes
     */
    /// Notice - Maximum length for _source will be 32 chars otherwise returned bytes32 value will have lossy value.
     ...
     * @return string representation of the bytes32
     */
