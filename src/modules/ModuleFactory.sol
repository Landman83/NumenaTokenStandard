...
abstract contract ModuleFactory is IModuleFactory, Ownable {
     ...
     */
    function changeSetupCost(uint256 _setupCost) public override onlyOwner {
     ...
     */
    function changeCostAndType(uint256 _setupCost, bool _isCostInPoly) public override onlyOwner {
        emit ChangeSetupCost(setupCost, _setupCost);
     ...
     */
    function changeTitle(string memory _title) public override onlyOwner {
     ...
     */
    function changeDescription(string memory _description) public override onlyOwner {
     ...
     */
    function changeName(bytes32 _name) public override onlyOwner {
     ...
     * @return lower bound
     */
    function getLowerSTVersionBounds() external view override returns(uint8[] memory) {
     ...
     * @return upper bound
     */
    function getUpperSTVersionBounds() external view override returns(uint8[] memory) {
    ...
    /**
     * @notice Should create an instance of the Module, or throw
     * @param _data Data used for the deployment of the module
     * @return moduleAddress Address of the module
     */
    function deploy(bytes calldata _data) external virtual override returns(address moduleAddress);
}
